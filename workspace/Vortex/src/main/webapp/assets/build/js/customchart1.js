			...
			success: function(response) {
				...
				var lineChart = new Chart(ctx, {
					...
					data: {
						...
						datasets: [{
							label: "# of male user",
							backgroundColor: "rgba(0, 114, 227, 0.31)",
							borderColor: "rgba(0, 75, 151, 0.7)",
							pointBorderColor: "rgba(0, 48, 96, 0.7)",
							pointBackgroundColor: "rgba(0, 48, 96, 0.7)",
							...
							borderColor: "rgba(174, 0, 0, 0.70)",
							pointBorderColor: "rgba(147, 0, 0, 0.70)",
							pointBackgroundColor: "rgba(147, 0, 0, 0.70)",
...
/*				console.log("label: " + label_);
	...
	if ($('#canvasDoughnut').length) {
		console.log('start doughnut chart');
		let gameType = {};
		let data_ = [];
		let label_ = [];
		...
		$.ajax({
			...
			success: function(response) {
				...
				for (prop in gameType) {
					label_.push(prop);
					data_.push(Number(gameType[prop]));
				};
