        ...
        <div class="row"> 
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
    			 ...
    			 <table cellpadding="0" cellspacing="0" border="0" class="dataTable table table-striped" id="gametable"></table>
                  </div>
                </div>
              </div>
              </div>    
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <!-- <p class="text-muted font-13 m-b-30">users of vortex</p> -->
    			 <table cellpadding="0" cellspacing="0" border="0" class="dataTable table table-striped" id="developertable"></table>
                  </div>
                </div>
              </div>
              </div>        
